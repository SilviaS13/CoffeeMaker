...
public class CoffeechiefModel {
    ...
    public CoffeechiefModel(){};

     public  CoffeechiefModel( String coffeeName, int espressoQuantity, int waterQuantity, int milkQuantity, int chocolateQuantity, int sugarQuantity){
